...
class FinancialDashboard {
    ...
    setDefaultDateRange() {
        ...
        this.currentDateRange.end = this.formatDate(today);
        this.currentDateRange.start = this.formatDate(thirtyDaysAgo);
    ...
    handlePresetPeriod(days) {
        ...
        this.currentDateRange.start = this.formatDate(startDate);
        this.currentDateRange.end = this.formatDate(today);
    ...
    async fetchDashboardData() {
        ...
        try {
            const response = await fetch(`/analysis/dashboard-data?start_date=${this.currentDateRange.start}&end_date=${this.currentDateRange.end}`);
    ...
    async fetchCategoryTransactions(category) {
        try {
            const url = `/analysis/category-transactions?category=${encodeURIComponent(category)}&start_date=${this.currentDateRange.start}&end_date=${this.currentDateRange.end}`;
