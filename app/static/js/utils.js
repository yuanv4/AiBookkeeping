    ...
    apiService: {
        ...
        async get(url, options = {}) {
            ...
            try {
                ...
                window.AppUtils.showNotification(`请求失败: ${error.message}`, 'error');
    ...
    ui: {
        ...
        async showConfirmationModal(options = {}) {
            ...
            if (typeof Swal !== 'undefined') {
                ...
                // 如果没有SweetAlert2，使用原生confirm
                console.warn('SweetAlert2 未加载，使用原生confirm对话框');
